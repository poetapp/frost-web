...
export const TextPrivacy = (props: TextPrivacyProps) => (
  <div className={classNames('TextPrivacy', props.className)}>
    ...
    <p>
      ...
      or<strong>&nbsp;"We"</strong>) respects your privacy and is committed to
    ...
    <p>
      ...
      <a href="http://www.po.et/">www.po.et/</a> (our "<strong>Website</strong>")
      and our practices for collecting, using, maintaining, protecting, and
      disclosing that information.&nbsp; By submitting personal information
      through the site or Services, you agree to the terms of this Privacy
      Policy, and you expressly consent to the collection, use and disclosure of
      your personal information in accordance with this Privacy Policy.
    </p>
    <p>This policy applies to information we collect:</p>
    <p>· On this Website.</p>
    <p>
      · In email, text, and other electronic messages between you, Poet and
      other users of the Poet platform.
    </p>
    <p>
      · When you interact with our APIs and applications on our website or
    ...
    <p>
      ...
      received personal information from a child under 18 without verification
      of parental consent, we will delete that information. If you believe we
      might have any information from or about a child under 18, please contact
      us at [inbox@Po.et]
    </p>
    <h2>Users Outside of the United States</h2>
    <p>
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;If you are a non U.S. user of the
      Site, by visiting the Website and providing us with data, you acknowledge
      and agree that your personal information may be processed for the purposes
      identified in this Privacy Policy.&nbsp; In addition, your personal
      information may be processed in the country in which it was collected an
      in other countries, including the United States, where laws regarding
      processing of personal information may be less stringent than the laws in
      your country.&nbsp; By providing your information, you consent to such
      transfer.
    </p>
    ...
    <p>
      ·&nbsp; by which you may be personally identified, such as name, date of
      birth, postal address, e-mail address, telephone number, government ID
      number, account information or any other identifier by which you may be
    ...
    <p>
      · From third parties, for example, our business partners, who have
      collected and may transfer your information to us.
    </p>
    <h2>Information You Provide to Us.&nbsp;&nbsp;</h2>
    <p>The information we collect on or through our Website may include:</p>
    <p>
      · Information that you provide by filling in forms on our Website to
      subscribe to or use our services. This includes information provided at
      the time of registering to use our Website, subscribing to our service,
      posting material, or requesting further services. We may also ask you for
      information to use certain features or when you report a problem with our
      Website.
    </p>
    <p>
    ...
    <p>
      ...
      (hereinafter, "<strong>posted</strong>") on public areas of the Website,
      ...
      control the actions of other users of the Website with whom you may choose
    ...
    <p>
      ...
      and we may maintain it or associate it with personal information we
      collect in other ways or receive from third parties. Collecting usage
      information helps us to improve our Website and to deliver a better and
    ...
    <p>
      ...
      information about your preferences and navigation to, from, and on our
      Website. Flash cookies are not managed by the same browser settings as are
    ...
    <p>
      ...
      e-mails may contain small electronic files known as web beacons (also
    ...
    <p>
      ...
      about your account/subscription, including expiration and renewal notices.
    </p>
    <p>
      ·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; To carry out our obligations
      and enforce our rights arising from any contracts entered into between you
      and us, including the Terms of Use and this Privacy Policy.
    </p>
    <p>
      ·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; To notify you about changes to
      our Website or any products or services we offer or provide though it.
    </p>
    <p>
    ...
    <p>
      ...
      information in this way, please send an email to privacy@Po.et.&nbsp; For
    ...
    <p>
      ·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; To our subsidiaries,
      affiliates, contractors, service providers, and other third parties we use
      to support our business and who are bound by contractual obligations to
    ...
    <p>
      ...
      dissolution, or other sale or transfer of some or all of Poet's assets,
      whether as a going concern or as part of bankruptcy, liquidation, or
      similar proceeding, in which personal information held by Poet about our
      Website users is among the assets transferred.
    </p>
    <p>
      ·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; To third parties to market
      their products or services to you if you have not opted out of these
      disclosures. We contractually require these third parties to keep personal
    ...
    <p>
      ·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; To enforce or apply the
      contracts between us including our terms of use and other agreements,
      including for billing and collection purposes, if applicable.
    </p>
    <p>
      ·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; If we believe disclosure is
      necessary or appropriate to protect the rights, property, or safety of
      Poet, our customers, or others.{' '}
    </p>
    ...
    <p>
      ...
      If you do not want us to share your personal information with unaffiliated
      or non-agent third parties for promotional purposes, you can opt-out by
    ...
    <p>
      ...
      sending us an email stating your request toprivacy@Po.et If we have sent
      you a promotional email, you may send us a return email asking to be
      omitted from future email distributions. This opt out does not apply to
      information provided to the Company as a result of a product service
    ...
    <p>
      You may also send us an email at inbox@Po.et to request access to, correct
      or delete any personal information that you have provided to us. We may
    ...
    <h2>Data Security</h2>
    <p>
      We have implemented measures, including multi-factor authentication,
      designed to secure your personal information from accidental loss and from
      unauthorized access, use, alteration, and disclosure. All information you
      provide to us is stored on our secure servers behind firewalls. Any
      payment transactions and transfers will be encrypted using SSL technology.{' '}
    </p>
    <p>
      Where we have given you (or where you have chosen) a password for access
      to certain parts of our Website, you are responsible for keeping this
    ...
    <p>Last modified: January 30, 2018</p>
    <h2>Introduction</h2>
    <p>
      Poet Technology Limited (<strong>"Company"</strong>
      or<strong>&nbsp;"We"</strong>) respects your privacy and is committed to
