...
export const SignUp = (props: SignUpProps) => 
    <Form onSubmit={props.onSubmit} onValidate={onValidate} legend={'Sign Up'} textButton={'Sign Up'}>
        <Input name={'email'} type={'email'} placeholder={'Email'} required />
        <Input name={'password'} type={'password'} placeholder={'Password'} required />
        <Input name={'confirmPassword'} type={'password'} placeholder={'Password'}  onChange={onchange.bind(this)} required />
